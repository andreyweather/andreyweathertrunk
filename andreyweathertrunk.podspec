...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/andreyweather/andreyweathertrunk.git", :tag => "#{spec.version}" }

  spec.source_files  = "andreyweathertrunk/*.{swift}"
